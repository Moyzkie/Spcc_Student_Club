...
if($email != false ){
    ...
    if($run_Sql){
        ...
        $displayrecord = $mysqli->query("SELECT * FROM club_event WHERE club_name = '$get_club'")or die(msqli_error($mysqli));
    }}else{
  ...
  ?>
    ...
    if($get_club == ''){
        ...
        $target_image= "image/event/".basename($image);
        
        // execute query
        mysqli_query($mysqli,"INSERT INTO club_event(club_name,event_name,description,image) VALUES ('$get_club','$event','$description','$image')");
   ...
   ?>
    <?php
     if (isset($_POST['edit'])) {
        ...
        // execute query
        mysqli_query($mysqli,"UPDATE club_event SET event_name='$event',description='$description',image='$image' where  id ='$id'");
   ...
   <?php
    if(isset($_GET['delete_event'])){
     $id=$_GET['delete_event'];
      $delete = $mysqli->query("DELETE FROM club_event WHERE id='$id'");
      header('location:event.php');
    } 
    ?>
   <html lang="en"><head>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar" >
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item fas fa-clipboard-list" data-toggle="modal" data-target="#addevent">Add Event</a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                   ...
                   <div class="card shadow mb-4">
                        <div style="background-color: rgb(25, 115, 250); " class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-white">Event Table</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-hover"  id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                     while($row = $displayrecord->fetch_assoc()):?>
                                        ...
                                        <a href="event.php?delete_event=<?php echo $row['id'];?>" class="btn btn-danger btn-sm">Delete</a>
                                        </td>
                                        </tr>
                                        <?php  endwhile; ?>
                                    </tbody>
   ...
   <div class="modal-content">
    <form action="event.php" METHOD="POST" enctype="multipart/form-data">
     ...
     <div class="modal-footer">
      ...
      <input type="submit" class="btn btn-success"  name="addevent" value="Save">
     </div>
    </form>
   </div>
  </div>
  ...
  <div class="modal-dialog">
   <div class="modal-content">
    <form action="event.php" METHOD="POST" enctype="multipart/form-data">
     ...
     <div class="form-group">
       <label>Event Name</label>
       <input type="text" name="event" id="events"  class="form-control" required>
      </div>   
      <div class="form-group">
       <label>Description</label>
       <textarea class="form-control" id="dess" name="des"  rows="4"></textarea>
      </div>
      <div class="form-group">
       <label>Image</label>
