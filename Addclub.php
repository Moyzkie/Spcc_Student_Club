...
require_once 'addclub_function.php';
?>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar" >
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="club_page.php">Club Page</a>
                           ...
                           <div class="card-body">
                            <form method="POST"  action="addclub.php" enctype="multipart/form-data">
                              <div class="row"> 
                                <div class="col-md-6">
                                  <div class="form-group bmd-form-group">
                                    <label class="bmd-label-floating">Name Of Club</label>
                                    <input  type="text" name="club_name" class="form-control" >
                                  </div>
                                </div>
                                <div class="col-md-6">
                                <?php
                                 $displayrecord = $mysqli->query("SELECT * FROM teachers_info")or die(msqli_error($mysqli));
                                 ?>
                                  <div class="form-group bmd-form-group">
                                    <label class="bmd-label-floating">Select Instractor</label>
                                    <select class="form-control" name="teacher_name" id="exampleFormControlSelect1">
                                    <?php
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group bmd-form-group">
                                    <label class="bmd-label-floating">Add Club Banner</label>
                                    <input type="file" name="club_banner" id="club_banner" class="form-control">
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group bmd-form-group">
                                    <label class="bmd-label-floating">Add Instractor Profie</label>
                                    <input type="file" name="teacher_profile" id="teacher_profile" class="form-control">
                                  </div>
                                </div>
                              </div>
                              <input style="background-color: rgb(25, 115, 250); color: white;" name="submit" id="submit" type="submit" class="btn pull-right" value="Save">
