...
if($email != false ){
    ...
    if($run_Sql){
        ...
        $displayrecord = $mysqli->query("SELECT * FROM student_info  WHERE club = '$get_club'")or die(msqli_error($mysqli));
    }
}else{
                ...
                <div class="container-fluid">
                   ...
                   <div class="card shadow mb-4">
                        <div style="background-color: rgb(25, 115, 250); " class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-white">My Student</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                     while($row = $displayrecord->fetch_assoc()):?>
                                        ...
                                        <td>
                                        <button type="button" class="btn btn-success btn-sm  editbtn"  data-toggle="modal" data-target="#editmodal">Message</button>
                                        <button type="button" class="btn btn-Danger btn-sm  editbtn"  data-toggle="modal" data-target="#editmodal">Remove</button>
                                        </td>
                                        </tr>
                                        <?php  endwhile; ?>
                                    </tbody>
