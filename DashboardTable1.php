...
<ul class="navbar-nav ml-auto">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div style="background-color: rgb(25, 115, 250); " class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-white">Teachers Information Table</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                     while($row = $displayrecord->fetch_assoc()):?>
                                        ...
                                        <a href="DashboardTable1.php?delete=<?php echo $row['id'];?>" class="btn btn-danger btn-sm">Delete</a>
                                        </td>
                                        </tr>
                                        <?php  endwhile; ?>
                                    </tbody>
 ...
 <div id="editmodal" class="modal fade">
  <div class="modal-dialog">
   <div class="modal-content">
    <form action="crud_teachers.php" METHOD="POST">
     <div style="background-color: rgb(25, 115, 250); "  class="modal-header">      
      <h4 style="color:white" class="modal-title">Edit Teachers Info</h4>
      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
     </div>
     <div class="modal-body">  
      <input type="text"id="ids" name="ids" class="form-control" hidden >
      <div class="form-group">
