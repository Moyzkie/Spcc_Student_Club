...
if($emails != false ){
    $sql = "SELECT * FROM admin WHERE username = '$emails'";
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar" >
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item fas fa-clipboard-list" data-toggle="modal" data-target="#carousel">Update Carousel</a>
                </div>
            </div>
        </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
               ...
               <div class="row mr-10">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                        Total Student</div>
                                         <?php
                                          $count_student = mysqli_query($mysqli,"SELECT COUNT(*) AS total FROM student_info");
                                          $row_count_student = mysqli_fetch_assoc($count_student);
                                           echo "<div class='h5 mb-0 font-weight-bold text-gray-800'>".$row_count_student['total']."</div>";
                                          ?>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                        Total Teachers</div>
                                        <?php
                                          $count_teachers = mysqli_query($mysqli,"SELECT COUNT(*) AS total FROM teachers_info");
                                          $row_count_teachers = mysqli_fetch_assoc($count_teachers);
                                           echo "<div class='h5 mb-0 font-weight-bold text-gray-800'>".$row_count_teachers['total']."</div>";
                                          ?>
                                </div>
                                <div class="col-auto">
                                    <i class="fas fa-user fa-2x text-gray-300"></i>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                        Total Club</div>
                                        <?php
                                          $count_club = mysqli_query($mysqli,"SELECT COUNT(*) AS total FROM club_list");
                                          $row_count_club = mysqli_fetch_assoc($count_club);
                                           echo "<div class='h5 mb-0 font-weight-bold text-gray-800'>".$row_count_club['total']."</div>";
                                          ?>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-info shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Active Event
                                    </div>
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                ...
                <div id = "sortable" class="row m-50 sortable">  
                   <?php
                   while ($row = mysqli_fetch_array($displayrecord)) {
                    ...
                    echo"<a href='spccDashboard.php?deletes=".$row['id']."'class='btn btns btn-danger'>Delete</a>";
                    echo"<a  href='#' name='update' class='btn btns btn-primary ml-4' data-toggle='modal' data-target='#editmodal'>Update</a>";
                    echo"</div>";
                    echo"</div>";
                  }
                 ?> 
...
<!-- Carousel Modal HTML -->
 <div id="carousel" class="modal fade">
    ...
    <form action="crud.php" METHOD="POST" enctype="multipart/form-data">
     ...
     <div class="modal-body">     
      <div class="form-group">
       <label>Slide1</label>
       <input  type="file" name="slide1"  id="fullname" class="form-control" >
      </div>
      <div class="form-group">
       <label>Slide2</label>
       <input type="file"id="slide2" name="slide2"   class="form-control" >
      </div>
      <div class="form-group">
       <label>Slide3</label>
       <input type="file"id="password" name="slide3"   class="form-control" >
      </div>
     </div>
     <div class="modal-footer">
      <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
      <input type="submit" class="btn btn-success"  name="up_carousel_save" value="Save">
     </div>
    </form>
   </div>
  </div>
    ...
    <form action="crud.php" METHOD="POST">
     ...
     <div class="modal-body">     
      ...
      <div class="form-group">
       ...
       <input type="file" name="club_banner" id="club_banner"  class="form-control">
      </div>
      <div class="form-group">
       <label>Instractor profile</label>
       <input type="file" name="teacher_profile" id="teacher_profile" class="form-control" required>
      </div>    
     </div>
     <div class="modal-footer">
      <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
      <input type="button" class="btn btn-success"  name="save" value="Update">
     </div>
    </form>
   </div>
  </div>
   ...
   <div id="loader">
    ...
    <script>
      ...
      $('#submit').click(function(){  
           var club_banner = $('#club_banner').val();
           var teacher_profile = $('#teacher_profile').val();
           
           if(club_banner == '' || teacher_profile == '' )  
           {  
                alert("Please Select Image");  
                 
                return false;  
           } else {  
                var extension1 = $('#club_banner').val().split('.').pop().toLowerCase();  
                var extension2 = $('#teacher_profile').val().split('.').pop().toLowerCase();  
                ...
                elseif(jQuery.inArray(extension2, ['gif','png','jpg','jpeg']) == -1)
                {
                    alert('Invalid Image File');  
                     $('#club_banner').val('');
                     $('#teacher_profile').val('');    
