...
if($email != false ){
    ...
    if($run_Sql){
        ...
        $displayrecord = $mysqli->query("SELECT * FROM club_works WHERE club_name = '$get_club'")or die(msqli_error($mysqli));
    }}else{
  ...
  ?>
    ...
    if($get_club == ''){
        ...
        $target_image= "image/works_image/".basename($image);
        $target_video= "video/".basename($video);
        
        // execute query
        mysqli_query($mysqli,"INSERT INTO club_works(club_name,description,image,video) VALUES ('$get_club','$description','$image','$video')");
   ...
   ?>
    ...
    // Get image & video name
        ...
        // execute query
        mysqli_query($mysqli,"UPDATE club_works SET description='$description',image='$image',video='$video' where  id ='$id'");
   ...
   ?>
   <?php
    if(isset($_GET['delete_works'])){
     $id=$_GET['delete_works'];
      $delete = $mysqli->query("DELETE FROM club_works WHERE id='$id'");
      header('location:works.php');
    } 
    ?>
   <html lang="en"><head>
...
<body id="page-top" class="sidebar-toggled">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar" >
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item fas fa-user-plus" data-toggle="modal" data-target="#addworks">Add Works </a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                   ...
                   <div class="card shadow mb-4">
                        <div style="background-color: rgb(25, 115, 250); " class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-white">Works Table</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover"  id="dataTable" width="100%" cellspacing="0">
                                    <thead class="text-center">
                                        <tr>
                                            <th>ID</th>
                                            <th data-width="400">Description</th>
                                            <th>Image</th>
                                            <th>Video</th>
                                            <th>Action</th>
                                        </tr>
                                    ...
                                    <?php
                                     while($row = $displayrecord->fetch_assoc()):?>
                                        ...
                                        <a href="works.php?delete_works=<?php echo $row['id'];?>" class="btn btn-danger btn-sm">Delete</a>
                                        </td>
                                        </tr>
                                        <?php  endwhile; ?>
                                    </tbody>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     ...
     <!--Add works modal-->
     <div id="addworks" class="modal fade">
  <div class="modal-dialog">
   <div class="modal-content">
    <form action="" METHOD="POST" enctype="multipart/form-data">
     <div class="modal-header">      
      <h4 class="modal-title">Add woks</h4>
      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
     </div>
     <div class="modal-body">     
      <div class="form-group">
       <label>Description</label>
       <textarea class="form-control" id="exampleFormControlTextarea1" name="des" rows="4"></textarea>
      </div>
      <div class="form-group">
       <label>Image</label>
     ...
     <div class="modal-footer">
      ...
      <input type="submit" class="btn btn-success"  name="addwork" value="Save">
     </div>
    </form>
   </div>
  </div>
  ...
  <div class="modal-dialog">
   <div class="modal-content">
    <form action="works.php" METHOD="POST" enctype="multipart/form-data">
     <div class="modal-header">      
      <h4 class="modal-title">edit woks</h4>
      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
     </div>
