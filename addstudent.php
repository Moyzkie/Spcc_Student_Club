                    ...
                    <div class="col-md-13">
                        <div class="card">
                          <div style="background-color: rgb(25, 115, 250); color: white;" class="card-header card-header-primary">
                            <h4 class="card-title">ADD SPCC STUDENT</h4>
                          </div>
                          <div class="card-body">
                          <?php
                           if(count($errors) == 1){ ?>
                            ...
                            ?>
                            <form action="addstudent.php" method="POST" autocomplete="">
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group bmd-form-group">
                                    <label class="bmd-label-floating"><b>Student Number</b></label>
                                    <input type="number" name="stdnumber" id="stdnumber"class="form-control" placeholder="Enter your student number" required >
                                  </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group bmd-form-group">
                                      <label class="bmd-label-floating"><b>Student FullName</b></label>
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group bmd-form-group">
                                      <label class="bmd-label-floating"><b>Student Username</b></label>
                                ...
                                <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group bmd-form-group">
                                        ...
                                        <input type="password" id="con_password" name="cpassword" class="form-control" placeholder="Please confirm your password" required>
                                      </div>
                                    </div>
                              </div>
                              <div class="row">
                              ...
                              <button style="background-color: rgb(25, 115, 250); color: white;" name="save" id="save" type="submit" class="btn  pull-right btn_submit">Save</button>
